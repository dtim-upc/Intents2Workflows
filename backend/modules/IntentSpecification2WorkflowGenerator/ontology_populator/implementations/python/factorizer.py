from ..simple.factorizer import factorizer_implemenation, factorizer_applier_implementation, columns_parameter, noncategorical_parameter
...
noncategorical_python_parameter = PythonTextParameter("noncategorical_columns", base_parameter=noncategorical_parameter, default_value="$$NONCATEGORICAL_COLUMNS$$", control_parameter=True)
python_factorizer_implementation = PythonImplementation(
    ...
    parameters=[
        ...
        noncategorical_python_parameter
    ],
