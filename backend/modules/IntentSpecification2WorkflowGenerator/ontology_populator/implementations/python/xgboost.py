...
python_xgboost_learner_implementation = PythonImplementation(
    ...
    parameters=[
        ...
        #                default_value=None),
        PythonFactorParameter('booster', ["gbtree","gblinear",'dart'], 
        ...
        PythonNumericParameter("base_score", XSD.double,
                        expression = AlgebraicExpression(cb.COPY,
                                                         ...
                                                         None),
                        default_value=0.5),
        PythonFactorParameter("objective", ["multi:softprob","binary:logistic"],
        ...
        PythonFactorParameter("feature_selector", ['cyclic', 'shuffle', 'random', 'greedy', 'thrifty'],
        ...
        PythonNumericParameter("colsample_bynode", XSD.double,
                        expression = AlgebraicExpression(cb.COPY,
                                                         ...
                                                         None),
                        default_value=1.0),
        PythonFactorParameter("tree_method", ['auto', 'exact', 'approx', 'hist'],
        ...
        PythonNumericParameter("scale_pos_weight", XSD.double,
                        expression = AlgebraicExpression(cb.COPY,
                                                         ...
                                                         None),
                        default_value=1.0),
        PythonFactorParameter("grow_policy", ['depthwise', 'lossguide'],
        ...
        PythonNumericParameter("max_bin", XSD.int,
                        expression = AlgebraicExpression(cb.COPY,
                                                         ...
                                                         None),
                        default_value=256),
        PythonFactorParameter('sample_type', ['uniform', 'weighted'],
        ...
        PythonFactorParameter('normalize_type', ['tree', 'forest'],
