...
cred_path = BASE_DIR / "OE_credentials.json"
...
class OptionExplorerClient:
    ...
    def __init__(self, base_url):
        ...
        self.token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..4G9gfqI0c50WwGNo2kF79Uv0AilUgr7NBQcC4i3qL6U"


    def get_best_options(self,intent_graph:Graph, ontology:Graph):
        ...
        if response.status_code == 200:
            ...
            for exp in resp.get('data',[]):
                translated_alg = self.mappings.get(exp['algorithm'],None)
    ...
    def login(self):
        ...
        try:
            # Making the POST request
            response = requests.post(f"{self.base_url}/user/login", data=login_body)
